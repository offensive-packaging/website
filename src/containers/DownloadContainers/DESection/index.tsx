              ...
              <Box display="flex" flexDirection="column" style={{ gap: 10 }}>
                ...
                {downloadOption && (
                  <SelectButton label="Download" variant="contained">
                    {Object.entries(downloadOption).map(([key, value]) => (
                      <SelectButtonItem key={key}>
                        {key === 'utm' ? (
                          <Link href={value}>
                            <a>{key} (Apple Silicon)</a>
                          </Link>
                        ) : (
                          <Link href={value}>
                            <a>{key} (amd64)</a>
                ...
                {downloadArchitect && (
                  <SelectButton label="Download" variant="contained">
                    {Object.entries(downloadArchitect).map(([key, value]) => (
                      <SelectButtonItem key={key}>
                        <Link href={value}>
                          <a>{key}</a>
                        </Link>
                ...
                {torrentArchitect && (
                  <SelectButton label="Torrent" variant="outlined">
                    {Object.entries(torrentArchitect).map(([key, value]) => (
                      <SelectButtonItem key={key}>
                        <Link href={value}>
                          <a>{key}</a>
                        </Link>
