                ...
                <Grid container item xs={12} md={4} spacing={3} wrap="wrap-reverse">
                  <Grid item xs={12} sm={6} md={12}>
                    ...
                    >
                      ...
                      <Typography variant="body2">5.3 Electro Ara</Typography>
                    </Box>
                    ...
                    >
                      ...
                      <Typography variant="body2">May 1, 2023</Typography>
                    </Box>
                    <Divider variant="fullWidth" />
                    <Box
                      display="flex"
                    ...
                    >
                      ...
                      <Typography variant="body2">292-430 MB</Typography>
                    </Box>
                  </Grid>
                  <Grid item xs={12} sm={6} md={12}>
                    <Box display="flex" flexDirection="column" style={{ gap: 10 }}>
                      <SelectButton label="Download" variant="contained">
                        <SelectButtonItem>
                          <Link href="https://deb.parrot.sh/parrot/iso/5.3/Parrot-core-rpi-5.3_armhf.img.xz">
                            armhf
                          </Link>
                        </SelectButtonItem>
                        <SelectButtonItem>
                          <Link href="https://deb.parrot.sh/parrot/iso/5.3/Parrot-core-rpi-5.3_arm64.img.xz">
                            arm64
                          </Link>
                        </SelectButtonItem>
                      </SelectButton>
                      <SelectButton label="Torrent" variant="outlined">
                        <SelectButtonItem>
                          <Link href="https://deb.parrot.sh/parrot/iso/5.3/Parrot-core-rpi-5.3_armhf.img.xz.torrent">
                            armhf
                          </Link>
                        </SelectButtonItem>
                        <SelectButtonItem>
                          <Link href="https://deb.parrot.sh/parrot/iso/5.3/Parrot-core-rpi-5.3_arm64.img.xz.torrent">
                            arm64
                          </Link>
                        </SelectButtonItem>
                      </SelectButton>
                      <PButton
                        variant="outlined"
                        to="https://deb.parrot.sh/parrot/iso/5.3/signed-hashes.txt"
                      >
                        Check Hashes
                      </PButton>
                    </Box>
              ...
              <Grid container spacing={8} justifyContent="center" alignItems="center">
                ...
                <Grid container item xs={12} md={4} spacing={3} wrap="wrap-reverse">
                  <Grid item xs={12} sm={6} md={12}>
                    ...
                    >
                      <Typography variant="body2Semi">Size</Typography>
                      <Typography variant="body2">893 MB - 1 GB</Typography>
                    </Box>
                  </Grid>
                  <Grid item xs={12} sm={6} md={12}>
                    <Box display="flex" flexDirection="column" style={{ gap: 10 }}>
                      <SelectButton label="Download" variant="contained">
                        <SelectButtonItem>
                          <Link href="https://deb.parrot.sh/parrot/iso/5.3/Parrot-home-rpi-5.3_armhf.img.xz">
                            armhf
                          </Link>
                        </SelectButtonItem>
                        <SelectButtonItem>
                          <Link href="https://deb.parrot.sh/parrot/iso/5.3/Parrot-home-rpi-5.3_arm64.img.xz">
                            arm64
                          </Link>
                        </SelectButtonItem>
                      </SelectButton>
                      <SelectButton label="Torrent" variant="outlined">
                        <SelectButtonItem>
                          <Link href="https://deb.parrot.sh/parrot/iso/5.3/Parrot-home-rpi-5.3_armhf.img.xz.torrent">
                            armhf
                          </Link>
                        </SelectButtonItem>
                        <SelectButtonItem>
                          <Link href="https://deb.parrot.sh/parrot/iso/5.3/Parrot-home-rpi-5.3_arm64.img.xz.torrent">
                            arm64
                          </Link>
                        </SelectButtonItem>
                      </SelectButton>
              ...
              <Grid container spacing={8} justifyContent="center" alignItems="center">
                ...
                <Grid container item xs={12} md={4} spacing={3} wrap="wrap-reverse">
                  <Grid item xs={12} sm={6} md={12}>
                    ...
                    >
                      <Typography variant="body2Semi">Size</Typography>
                      <Typography variant="body2">2.1 - 2.5 GB</Typography>
                    </Box>
                  </Grid>
                  <Grid item xs={12} sm={6} md={12}>
                    <Box display="flex" flexDirection="column" style={{ gap: 10 }}>
                      <SelectButton label="Download" variant="contained">
                        <SelectButtonItem>
                          <Link href="https://deb.parrot.sh/parrot/iso/5.3/Parrot-security-rpi-5.3_armhf.img.xz">
                            armhf
                          </Link>
                        </SelectButtonItem>
                        <SelectButtonItem>
                          <Link href="https://deb.parrot.sh/parrot/iso/5.3/Parrot-security-rpi-5.3_arm64.img.xz">
                            arm64
                          </Link>
                        </SelectButtonItem>
                      </SelectButton>
                      <SelectButton label="Torrent" variant="outlined">
                        <SelectButtonItem>
                          <Link href="https://deb.parrot.sh/parrot/iso/5.3/Parrot-security-rpi-5.3_armhf.img.xz.torrent">
                            armhf
                          </Link>
                        </SelectButtonItem>
                        <SelectButtonItem>
                          <Link href="https://deb.parrot.sh/parrot/iso/5.3/Parrot-security-rpi-5.3_arm64.img.xz.torrent">
                            arm64
                          </Link>
                        </SelectButtonItem>
                      </SelectButton>
